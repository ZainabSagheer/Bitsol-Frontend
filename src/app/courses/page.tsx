...
export default function CoursesPage() {
  return (
    <div className="pt-32 pb-24 bg-brand-dark">
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {courses.map((course, i) => (
          <motion.div
            ...
            className="glass-card flex flex-col overflow-hidden group hover:border-brand-purple/50 transition-all"
          >
            <div className="h-60 relative overflow-hidden">
              ...
              <div className="absolute top-4 left-4 flex gap-2">
                {course.tags.map((tag, j) => (
                  <Badge key={j} className="bg-brand-dark/80 backdrop-blur-md border-white/10 text-brand-cyan">
                    {tag}
                  </Badge>
                ))}
              </div>
            ...
            <div className="p-8 flex flex-col flex-grow">
              ...
              <h3 className="text-2xl font-bold mb-4 group-hover:text-brand-cyan transition-colors">
                {course.title}
              </h3>
              ...
              <div className="mt-auto">
                ...
                <Button className="w-full bg-brand-purple hover:bg-brand-purple/90 rounded-xl py-6 font-bold text-lg">
                  Enroll Now
                </Button>
              </div>
            </div>
      ...
      <div className="container mx-auto px-6 mt-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl font-bold mb-8">Why Learn With BITSOL?</h2>
          ...
          <div className="relative">
             ...
             <div className="glass-card p-10 relative z-10 text-center">
                <BookOpen className="w-20 h-20 text-brand-cyan mx-auto mb-6" />
                <h3 className="text-3xl font-bold mb-4">Student Community</h3>
